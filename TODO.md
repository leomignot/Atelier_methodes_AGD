...
- en vrai sans doute possible de simplifier avec les téléchargements mutuels, mais pas forcéement utile de se prendre la tête et autant afficher ce qui est importé en dur pour rendre visible pour les non initiés ? pas sur que ne pas faire apparaitre ggplot2 parce qu'il est compris dans les requirements d'autres pacakges soit bien clair
- aviser ce que l'on fait du script ? > Premier passage : j'ai corrigé les chemins de fichier et j'ai intégré ce que moi j'avais codé à l'arrache pendant la séance + corrigé des éléments. On est grossomodo au même stade que le notebook.
...
- template de holtzy ? (cf enquête doc). Sinon rester simple c'est bien. > Pour l'instant simple.
